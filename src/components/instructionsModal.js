...
export function createInstructions() {
    ...
    modalBox.innerHTML = `
        ...
        <button id="startPlaying" class="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium text-lg py-3 px-4 rounded-xl mt-6 transition-all transform shadow-lg">
            Entendi!
        </button>
    `;
