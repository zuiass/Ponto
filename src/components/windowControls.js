export function createWindowControls() {
    return `
        <div id="title-bar" class="fixed top-0 left-0 right-0 flex mb-5 justify-end items-center bg-gray-800 h-10 select-none" style="-webkit-app-region: drag; z-index: 1000;">
