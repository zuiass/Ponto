export function createGameButton({
    ...
    button.id = id;
    button.type = 'button';
    button.className = "game-button border-[1px] border-gray-300 dark:bg-gradient-to-br dark:from-gameButton-midOne/90 dark:to-gameButton-midTwo bg-gradient-to-br from-white to-gray-300 opacity-0 scale-125 transition-all duration-700 ease-out flex flex-col rounded-3xl p-4 justify-between items-center w-32 h-32";
...
lineOne.appendChild(createGameButton({
    ...
    imgClass: "invert-0 brightness-0",
    label: "Pondeto"
}));
